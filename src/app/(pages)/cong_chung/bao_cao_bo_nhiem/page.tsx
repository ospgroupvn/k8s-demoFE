...
import { reportAppoint } from "@/service/notaryOrg";
...
const DEFAULT_COLUMNS = [
  { index: 2, label: "Số lượng Người tập sự" },
  { index: 3, label: "Số lượng Người đề nghị bổ nhiệm CCV" },
  { index: 4, label: "Số lượng Người đề nghị miễn nhiệm CCV" },
  { index: 5, label: "Số lượng Người đề nghị bổ nhiệm lại CCV" },
  { index: 6, label: "Số lượng bổ nhiệm CCV" },
  { index: 7, label: "Số lượng miễn nhiệm CCV" },
  { index: 8, label: "Số lượng bổ nhiệm lại CCV" },
];
...
const ReportAppoint = () => {
  ...
  const query = useQuery({
    queryKey: [QUERY_KEY.CONG_CHUNG.BAO_CAO_BO_NHIEM, searchParam],
    queryFn: reportAppoint,
    refetchOnWindowFocus: false,
  });
  ...
  //   queryKey: [
  //     QUERY_KEY.CONG_CHUNG.BAO_CAO_BO_NHIEM,
  //     { aTypes: ["6"], numberPerPage: 100, pageNumber: 1 },
  //   ],
  //   queryFn: reportAppoint,
  //   refetchOnWindowFocus: false,
  ...
  const columns: ColumnDef<ReportItem>[] = [
    ...
    },
    {
      accessorKey: "col_2",
      header: () => (
        <div className="line-clamp-3 min-w-[120px]">Số lượng Người tập sự</div>
      ),
      cell: ({ row }) => (
        <div
          className={cn(
    ...
    },
    {
      ...
      header: () => (
        <div className="line-clamp-3 min-w-[120px]">
          Số lượng Người đề nghị bổ nhiệm CCV
        </div>
      ),
      cell: ({ row }) => (
        <div
    ...
    },
    {
      ...
      header: () => (
        <div className="line-clamp-3 min-w-[120px]">
          Số lượng Người đề nghị miễn nhiệm CCV
        </div>
      ),
      cell: ({ row }) => (
        <div
    ...
    },
    {
      ...
      header: () => (
        <div className="line-clamp-3 min-w-[120px]">
          Số lượng Người đề nghị bổ nhiệm lại CCV
        </div>
      ),
      cell: ({ row }) => (
        <div
    ...
    },
    {
      accessorKey: "col_6",
      header: () => (
        <div className="line-clamp-3 min-w-[120px]">Số lượng bổ nhiệm CCV</div>
      ),
      cell: ({ row }) => (
        <div
          className={cn(
  ...
  const onExportClick = () => {
    ...
    let url =
      ...
      `/private/tccc/exportExcelReportOperationSuggestAppoint?`;
    ...
    const filename = `${format(
      new Date(),
      "dd-MM-yyyy"
    )}_Báo cáo bổ nhiệm Công chứng viên.xlsx`;
  ...
  return (
    <>
      <h1 className="text-lg font-bold mb-6 uppercase">
        Báo cáo bổ nhiệm Công chứng viên
      </h1>
      ...
      <Tabs defaultValue="chartTab" className="mt-3">
        ...
        >
          <p className="font-bold mb-4 w-full">
            Biểu đồ bổ nhiệm Công chứng viên
          </p>

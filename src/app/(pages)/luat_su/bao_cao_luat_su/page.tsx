...
const ReportLawyerActive = () => {
  ...
  const query = useQuery({
    queryKey: [QUERY_KEY.LUAT_SU.BAO_CAO_LUAT_SU, searchParam],
  ...
  const queryAll = useQuery({
    queryKey: [
      QUERY_KEY.LUAT_SU.BAO_CAO_LUAT_SU_ALL,
  ...
  return (
    <>
      <h1 className="text-lg font-bold mb-6">
        BÁO CÁO SỐ LIỆU LUẬT SƯ ĐANG HÀNH NGHỀ
      </h1>
      ...
      <Tabs defaultValue="chartTab" className="mt-3">
        ...
        >
          <p className="font-bold mb-4 w-full">
            Biểu đồ số liệu Luật sư đang hành nghề
          </p>
...
export default ReportLawyerActive;

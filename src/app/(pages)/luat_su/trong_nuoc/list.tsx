...
const LawyerDomesticList = () => {
  ...
  return (
    <>
      <h1 className="text-lg font-bold mb-6">DANH SÁCH LUẬT SƯ TRONG NƯỚC</h1>
...
export default LawyerDomesticList;
